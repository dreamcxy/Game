...
ufo = pygame.image.load('air/image/ufo2.png').convert_alpha()
background = pygame.image.load('air/image/background.png').convert_alpha()
gameover_image = pygame.image.load('air/image/game_over.png').convert_alpha()
plane_image = pygame.image.load('air/image/hero1.png').convert_alpha()
bullet_image = pygame.image.load('air/image/bullet1.png').convert_alpha()
enemy_image = pygame.image.load('air/image/enemy2.png').convert_alpha()
logo = pygame.image.load('air/image/shoot_copyright.png').convert_alpha()
bomb_num = pygame.image.load('air/image/bomb.png').convert_alpha()
bomb_image = pygame.image.load('air/image/bomb.png').convert_alpha()
loading = []
loading.append(pygame.image.load(
    'air/image/game_loading1.png').convert_alpha())
loading.append(pygame.image.load(
    'air/image/game_loading2.png').convert_alpha())
loading.append(pygame.image.load(
    'air/image/game_loading3.png').convert_alpha())
enemydown = []
enemydown.append(pygame.image.load(
    'air/image/enemy2_down1.png').convert_alpha())
enemydown.append(pygame.image.load(
    'air/image/enemy2_down2.png').convert_alpha())
enemydown.append(pygame.image.load(
    'air/image/enemy2_down3.png').convert_alpha())
enemydown.append(pygame.image.load(
    'air/image/enemy2_down4.png').convert_alpha())
boom = []
boom.append(pygame.image.load('air/image/bomb.png').convert_alpha())
boom.append(pygame.image.load('air/image/bomb.png').convert_alpha())
boom.append(pygame.image.load('air/image/bomb.png').convert_alpha())
boom.append(pygame.image.load('air/image/bomb.png').convert_alpha())
boom.append(pygame.image.load('air/image/bomb.png').convert_alpha())
...
class Bomb(object):
    ...
    def boom(self):
        n = self.boomcount/10
        screen.blit(boom[n], (self.boom_x-boom[n].get_width() /
                              2, self.boom_y-boom[n].get_height()/2))
        self.boomcount += 1
...
def run():
    sound = True
    gameStart = Button('start.png', 'start_down.png',
                       (SCREEN_SIZE[0]/2, SCREEN_SIZE[1]*8/12))
    gameOver = Button('start.png', 'start_down.png',
                      (SCREEN_SIZE[0]/2, SCREEN_SIZE[1]*11/12))
    gameAgain = Button('start.png', 'start_down.png',
                       (SCREEN_SIZE[0]/2, SCREEN_SIZE[1]*10/12))
    gameContinue = Button('start.png', 'start_down.png', (SCREEN_SIZE[
                          0]/2, SCREEN_SIZE[1]*9/12))
    loadingCount = 0
        ...
        if gamePause:
           ...
           # interval_b2 -= 1
            ...
            if interval_e < 0:
                ...
                interval_e = randint(max(0, 30-SCORE/250),
                                     max(7, 50-SCORE/700))
